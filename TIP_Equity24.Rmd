...
points_bg <-       read.csv(paste(home_dir, "TIP_24_28_points_area_fractions_v2.csv", sep=""))
points_tract <-    read.csv(paste(home_dir, "TIP_24_28_points_area_fractions_tracts_v2.csv", sep=""))
lines_bg <-        read.csv(paste(home_dir, "TIP_24_28_lines_area_fractions_v2.csv", sep=""))
lines_tract <-     read.csv(paste(home_dir, "TIP_24_28_lines_area_fractions_tracts_v2.csv", sep=""))
polygons_bg <-     read.csv(paste(home_dir, "TIP_24_28_polygon_area_fractions_v2.csv", sep=""))
polygons_tract <-  read.csv(paste(home_dir, "TIP_24_28_polygon_area_fractions_tracts_v2.csv", sep=""))

tip_bg_cen20 <- do.call("rbind", list(points_bg,
                                      lines_bg,
                                      polygons_bg))

tip_tract_cen20 <- do.call("rbind", list(points_tract,
                                      lines_tract,
                                      polygons_tract))

# Access to Infrastructure version
tip_bg_cen20 <- read.csv("C:\\Users\\sstrumwasser.AD\\Documents\\Access_to_Infrastructure\\outputs\\bluebikes_area_fractions_bg_point25_mi.csv")

tip_tract_cen20 <- read.csv("C:\\Users\\sstrumwasser.AD\\Documents\\Access_to_Infrastructure\\outputs\\bluebikes_area_fractions_tract_point25_mi.csv")
...
tip_bg_acs <- merge(tip_bg_cen20 %>% select(geoid, area_fraction,TIP_ID), acsbgs, by.x =char('geoid'), by.y ='GEOID')
...
```{r}
#2020 Census
tip_bg_cen$TotalPop_AF <- round(tip_bg_cen$P2_001N*tip_bg_cen$area_fraction)
tip_bg_cen$MinPop_AF   <- round(tip_bg_cen$MinPop*tip_bg_cen$area_fraction)
...
write.csv(final, "\\Users\\sstrumwasser.AD\\Documents\\Access_to_Infrastructure\\outputs\\bluebikes_equity_quarter_mile.csv")
