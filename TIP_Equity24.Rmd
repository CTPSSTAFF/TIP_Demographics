...
```{r}
# configuration
input_blkgrps_table <- "\\Users\\sstrumwasser.AD\\Documents\\ArcGIS\\Projects\\needs_assessment_proximity\\arcpy_outputs\\charging_stations_AF_blkgrps_quarter_mile.csv"
input_tracts_table <- "\\Users\\sstrumwasser.AD\\Documents\\ArcGIS\\Projects\\needs_assessment_proximity\\arcpy_outputs\\charging_stations_AF_tracts_quarter_mile.csv"
...
output_table <- "\\Users\\sstrumwasser.AD\\Documents\\ArcGIS\\Projects\\needs_assessment_proximity\\R_outputs\\charging_stations_quarter_mile_equity.csv"
```
