---
title: "TIP_Equity22 (2020 ACS Update)"
author: "Margaret Atkinson | Steven Andrews"
date: "2022-01-30 | Updtate: 2022-03-29"
...
tip_bg_acs19 <- read_csv("./data/tip_bg_acs19.csv") %>% mutate(geoid = as.character(geoid))
tip_bg_cen20 <- read_csv("./data/tip_bg_cen20.csv") %>% mutate(geoid_20 = as.character(geoid_20))
...
tip_bg_cen <- merge(tip_bg_cen20 %>% select(geoid20 = geoid_20, area_fraction,tip_id), bg20, by.x ='geoid20', by.y ='GEOID')
...
write.csv(final, "./output/tip_demographics_2020ACS_2020Cen.csv")
