...
Demographics for the same geography are obtained using the `tidycensus` package in 01_TIP_Equity22.rmd. The two datasets are merged to find the various proprotions of relevant demographics near the TIP projects.
...
tip_demog_pct_num_2019ACS_2020Cen.csv contains the final output of the scripts.
...
In tip_demog_pct_2020ACS_2020Cen.csv note that there are only 53 TIP projects instead of the expected 56.
...
This script fixes a previous error that used P1_003N (White Alone) instead of P2_005N (White Alone, non-Hispanic/Latino).
