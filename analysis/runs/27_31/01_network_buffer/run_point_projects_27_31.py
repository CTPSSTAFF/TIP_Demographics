...
point_projects = home_dir + r'\gdbs\points.gdb\point_projects_021126'
...
# Check project count
print('Count before join:', arcpy.GetCount_management(proj_layer)[0])

# Join buffers to projects
arcpy.AddJoin_management(proj_layer, "PROJIS", buffers, "ID")

# Check project count
print('Count after join:', arcpy.GetCount_management(proj_layer)[0])
